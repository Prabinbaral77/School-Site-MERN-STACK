    ...
    return (
        <div className="mb-20">
            ...
            <div className="flex flex-col md:flex-row">
                <div className="relative h-[300px] lg:min-w-[250px] sm:min-w-[190px] mx-[50px] mb-4 md:mx-[70px]">
                ...
                <div className="ml-8 px-4 font-semibold text-gray-600 flex-grow lg:text-xl md:pt-16 shadow-lg"> 
